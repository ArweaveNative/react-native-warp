...
export declare class DefaultCreateContract implements CreateContract {
    ...
    createBundlrTxFromSourceTx(contractData: FromSrcTxContractData, disableBundling?: boolean): Promise<Transaction>;
    deployContractFromBundlrTx(contractTX: Transaction): Promise<ContractDeploy>;
    private post;
}
